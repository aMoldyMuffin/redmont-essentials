...
| `TURNSTILE_SECRET_KEY` | [Cloudflare Turnstile](https://dash.cloudflare.com/?to=/:account/turnstile) secret — blocks order spam |

In `js/config.js`, set `turnstileSiteKey` to your Turnstile **site key** (public).
